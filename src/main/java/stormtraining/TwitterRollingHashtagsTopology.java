 ...
 */
public class TwitterRollingHashtagsTopology {
  ...
  public TwitterRollingHashtagsTopology(String topologyName) throws InterruptedException {
  ...
  private void wireTopology() throws InterruptedException {
    String spoutId = "hastagsGenerator";
    String counterId = "counter";
    String intermediateRankerId = "intermediateRanker";
    String totalRankerId = "finalRanker";
    
    
    // Change this spout for the newly created TwitterHashtagsSpout 
    builder.setSpout(spoutId, new TestWordSpout(), 5);
    
    // Connect the messages of the previous spout to a newly created bolt, named TwitterHashtagsSplitterBolt
